...
$(p_NAME): v3d_func_rep.o mk.o structure_c.o llist_c.o rmsd_m.o testprog.o
	$(FC) $(FCFLAGS) v3d_func_rep.o mk.o structure_c.o llist_c.o rmsd_m.o testprog.o $(LDFLAGS) -o $(p_NAME)
